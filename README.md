...
**🔗 Live Demo:** [https://career-board-x7uq-sable.vercel.app](https://career-board-x7uq-sable.vercel.app)
...
```bash
git clone https://github.com/lksahu120206-gif/CareerBoard.git
cd CareerBoard
...
Configure your Supabase backend with the following tables:
